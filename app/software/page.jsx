...
<section className='sys-cards py-14'>
    <Container>
        <section className='flex gap-10 justify-between flex-wrap'>
            <div  className='scard py-8 px-12 text-right'>
                <Image width={90} height={80} src='/assets/scard1.png' alt=''  />
                <h3 className='text-white font-bold text-lg py-4'>ألمبيعات</h3>
                <p className='text-xs mb-6' style={{lineHeight: '1.9' , color : '#C4C4C4'}}>
        امكانية تخصيص نظام دفترة حساب مجال عملك بما في ذلك التصميمات المضنة و الواجهات لتحقيق اهداف عمل               
        امكانية تخصيص نظام دفترة حساب مجال عملك بما في ذلك التصميمات المضنة و الواجهات لتحقيق اهداف عمل  
              </p>
              <Link href='/sales' className='readmore'>مشاهدة المزيد
              <KeyboardDoubleArrowLeftIcon />
              </Link>
            </div>

            <div  className='scard py-8 px-12 text-right'>
                <Image width={90} height={80} src='/assets/scard2.png' alt=''   />
                <h3 className='text-white font-bold text-lg py-4'>المبيعات</h3>
                <p className='text-xs mb-6' style={{lineHeight: '1.9' , color : '#C4C4C4'}}>
        امكانية تخصيص نظام دفترة حساب مجال عملك بما في ذلك التصميمات المضنة و الواجهات لتحقيق اهداف عمل               
        امكانية تخصيص نظام دفترة حساب مجال عملك بما في ذلك التصميمات المضنة و الواجهات لتحقيق اهداف عمل  
              </p>
              <Link href='/' className='readmore'>مشاهدة المزيد
              <KeyboardDoubleArrowLeftIcon />
              </Link>
            </div>
             ...
             <div className='scard py-8 px-12 text-right'>
                <Image width={90} height={80} src='/assets/scard3.png' alt=''   />
        ...
        امكانية تخصيص نظام دفترة حساب مجال عملك بما في ذلك التصميمات المضنة و الواجهات لتحقيق اهداف عمل  
             ...
             <div className='scard py-8 px-12 text-right'>
                <Image width={90} height={80} src='/assets/scard4.png' alt=''   />
        ...
        امكانية تخصيص نظام دفترة حساب مجال عملك بما في ذلك التصميمات المضنة و الواجهات لتحقيق اهداف عمل  
             ...
             <div className='scard py-8 px-12 text-right'>
                <Image width={90} height={80} src='/assets/scard5.png' alt=''   />
        ...
        امكانية تخصيص نظام دفترة حساب مجال عملك بما في ذلك التصميمات المضنة و الواجهات لتحقيق اهداف عمل  
             ...
             <div className='scard py-8 px-12 text-right'>
                <Image width={90} height={80} src='/assets/scard6.png' alt=''   />
